...
#define ANS_LEN 3
SEXP ngarch11_B(SEXP x, SEXP par, SEXP ll_only)
{
    int 
        numprot = 0;
    long 
                     ...
                     SEXP options)
{
    ...
    PROT2( tmp = ngarch11_B( x, getListElt( fit2, "par" ), ScalarInteger( 0 )), 
           numprot);
...
SEXP sim_ngarch11_2_B( SEXP T, SEXP npaths, SEXP par,
                       SEXP x0, SEXP h0, SEXP z)
{
    int zlen; 
    int numprot = 0;
